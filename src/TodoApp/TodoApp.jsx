...
function TodoApp() {
  ...
  function doneNotDoneTodos() {
    ...
    const visoTodo = mainTodoArray.length;
    const atliktaTodo = mainTodoArray.filter((obj) => obj.isDone === true).length;
    return {
      done: atliktaTodo,
      total: visoTodo,
    };
  ...
  return (
    <div className='container'>
      <Header onResetTodo={resetTodo} counter={doneNotDoneTodos} />
      <TodoList
        data={mainTodoArray}
